...
var results = function results() {
  ...
  } else if (action.type === _actionTypes.MUTATE_START && action.optimisticResults) {
    return state.merge(action.optimisticResults);
  } else if (action.type === _actionTypes.MUTATE_FAILURE && action.rolledBackResults) {
  ...
  } else if (action.type === _actionTypes.UPDATE_RESULTS) {
